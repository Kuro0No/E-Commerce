    ...
    return (
        <GlobalTitle title="Trang chủ">
                    ...
                    <Slider className="" {...settings} ref={customeSlider}>
                        ...
                        {products.products.map((product, index) => (
                            <div key={index}>
                                ...
                                <Link active to={`/product/${product.id}/${product.name}`} className="card mx-2 p-0" >
                                    <div className="col">
                                        <div className="card">
            ...
            <div className=' container mt-5 mx-auto row imgProductHome p-0 '>
                ...
                {products.products.map((product, index) => (
                    <div className="col-sm-6 col-lg-3 p-0 mb-4" key={index}>

                        <Link active to={`/product/${product.id}/${product.name}`} className="card  mx-4 p-0" key={index}>
                            <img src={product.img} className="card-img-top" alt="..." />
                            <div className="card-body">
                                <h5 className="card-title">{product.name}</h5>
